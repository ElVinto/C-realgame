...
class PeriodController extends Controller
{
   ...
   public function store(Request $request)
   {
    ...
    public function show($id)
    {
      ...
      return view('period.periodShow', compact('game','periods','idMax','id','informations', 'message', 'numMax', 'bilan','nbrPeriodes','period'));
    }
    ...
    { 
     ...
     //Récupération des période de la partie
      ...
      /*$quantiteRestante = Session::get('quantiteRestante');
      $contratsRestante = Session::get('contratsRestante');*/
      return view('period.periodEdit', compact('game','periods','idMax','isSold', 'informations', 'editParam', 'termPrice', 'gainCumul','numMax','numberContrat','nbrPeriodes','spotPrice','EBM','quantiteTotal','quantite'));
    }
