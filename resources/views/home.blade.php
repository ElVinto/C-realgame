...
@section('body')
    ...
    <div class="bg-color">
      ...
      <div class="container text-center">
        <div class="wrapper wow fadeInUp delay-05s">
          ...
          @guest
            <a href="{{ route('login') }}" class="btn btn-submit">Jouer maintenant</a>
          @else
            @auth('admin')
            ...
            @endauth
          @endguest
          <br><button id="showGuide" class="btn btn-submit">Mode d'emploi </button>
        </div>
      </div>
    </div>
  </header><br>
  ...
  <div class="container">
      <div class="row">
        ...
        <h3> Guide d'utilisation C-real game</h3> 
  ...
  <section id="cta-1">
    <div class="container">
      <div class="row">
        ...
        <h2>Tutoriel</h2>
          <video  width="90%" height="auto" autoplay controls controlslist="nofullscreen nodownload noremoteplayback foobar noprogressbar" src="TUTO.mp4" ></video><br>
    </div></div></div>
  </section>
  <!---->
  <!---->
